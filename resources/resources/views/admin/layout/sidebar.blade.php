    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item {{ request()->routeIs(['admin.users.index', 'admin.users.add', 'admin.users.edit']) ? 'active' : '' }}">
                    <a href="{{ route('admin.users.index') }}" class="collapsed">
                        <i class="fa-solid fa-users"></i>
                        <p>Người dùng</p>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs(['admin.treasury.index', 'admin.treasury.create', 'admin.treasury.edit']) ? 'active' : '' }}">
                    <a href="{{ route('admin.treasury.index') }}" class="collapsed">
                        <i class="fa-solid fa-users"></i>
                        <p>Phiếu thu chi</p>
                    </a>
                </li>
